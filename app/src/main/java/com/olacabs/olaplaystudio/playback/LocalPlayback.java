...
public final class LocalPlayback implements Playback {
                ...
                public void onReceive(Context context, Intent intent) {
                    if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intent.getAction())) {
                        ...
                        if (isPlaying()) {
                            ...
                            i.setAction(MusicService.Companion.getACTION_CMD());
                            i.putExtra(MusicService.Companion.getCMD_NAME(), MusicService.Companion.getCMD_PAUSE());
    ...
    public void play(String item) {
        ...
        boolean mediaHasChanged = !TextUtils.equals(item, mCurrentMediaId);
        if (mediaHasChanged) {
            mCurrentMediaId = item;
        }
        ...
        if (mediaHasChanged || mExoPlayer == null) {
            ...
            //For Url Redirection
            String userAgent = Util.getUserAgent(mContext, "OLa Music Player");
    ...
    private void configurePlayerState() {
        Timber.d("configurePlayerState. mCurrentAudioFocusState= %s", mCurrentAudioFocusState);
    ...
    private final class ExoPlayerEventListener implements ExoPlayer.EventListener {
        ...
        public void onPlayerError(ExoPlaybackException error) {
            ...
            Timber.e("ExoPlayer error: what=%s", what);
            if (mCallback != null) {
